...
The Android Compact widget uses smaller text and a flat Focus list for small widget spaces. It has no list chooser or inline completion control; tapping a task opens the same native detail sheet.

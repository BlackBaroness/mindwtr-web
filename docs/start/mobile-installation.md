...
TestFlight beta is also available at https://testflight.apple.com/join/7SMJCTSR. See [Join the Beta Channels](/start/beta-channels) for leave-beta instructions and other beta platforms.
...
See [Data and Sync](/data-sync/) for sync troubleshooting.

...
Tareas completadas que se han apartado. Las tareas archivadas se ocultan de las listas normales, pero aquí puedes buscarlas o restaurarlas. Haz clic en el título de una tarea para abrir sus notas, subtareas y adjuntos en modo de solo lectura, sin restaurarla. Haz clic en la marca de tiempo **Completada** para corregirla, o usa la acción de restaurar de la fila para devolver la tarea a la Bandeja de entrada. Un selector Tareas | Proyectos en la parte superior muestra en su lugar los proyectos archivados: restaurar uno lo reactiva (recuperando las tareas completadas con él) y eliminarlo lo envía a la Papelera. Haz clic en el nombre de un proyecto archivado para abrirlo en Proyectos en modo de solo lectura, con las tareas completadas con él.

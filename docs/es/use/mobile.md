...
El widget Compacto de Android usa texto más pequeño y una lista plana de Foco para espacios pequeños. No tiene selector de lista ni control de finalización en línea; al tocar una tarea se abre la misma ficha nativa.

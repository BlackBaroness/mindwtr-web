...
En Android, tocar el anillo del widget Tareas completa la tarea. La fila aparece tachada de inmediato. La tarea sigue tachada en el widget hasta que Mindwtr se ejecute la próxima vez y la complete allí; desde la aplicación también se sincroniza con tus otros dispositivos. Tocar el anillo de una fila tachada lo deshace, tanto en los primeros segundos como después, mientras la aplicación no la haya recogido todavía.

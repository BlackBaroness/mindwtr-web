...
Le widget Compact d’Android utilise un texte plus petit et une liste Focus à plat pour les petits espaces. Il n’a ni sélecteur de liste ni commande de validation intégrée ; toucher une tâche ouvre la même fiche native.
...
Sous Android, toucher l’anneau du widget Tâches termine la tâche. La ligne est barrée aussitôt. La tâche reste barrée sur le widget jusqu’au prochain lancement de Mindwtr, qui la termine alors ; c’est aussi depuis l’application qu’elle est synchronisée avec vos autres appareils. Toucher l’anneau d’une ligne barrée annule l’action, pendant les premières secondes comme après, tant que l’application ne l’a pas encore prise en compte.
